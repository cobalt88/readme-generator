...
If you have any comments, suggestions, concerns, feel free to either open an issue or reach out to me directly at ${answers.email}
Be sure to also check out my other projects and visit my GitHub profile at ${githubURL(answers.username)}
`;
return markdown;
}
...
// TODO: Create a function to write README file
 const writeToFile = (markdown) => {
   console.log('made it into write file function')
    fs.writeFile("./dist/README.md", markdown);
 }

// TODO: Create a function to initialize app
const init = async () => {
  try{
    let response = promptUser();
    let data = await markdown(response);
